...
if(k>k1){
  frs(i,id-(k/2),id-1)cout<<s[i]; 
  frs(i,id,id+(k/2))cout<<s[i];
  nl;
}else{
    frs(i,id1-(k1/2-1),id1)cout<<s[i];
    frs(i,id1+1,id1+(k1/2))cout<<s[i];
}
}
